...
export const delegateTaskTool: Tool = {
	...
	parameters: [
		{ name: "intent", type: "string", description: "The agent category to spawn (must be one of: 'review_task', 'synthesize_task', 'plan_task', 'factcheck_task', 'write_task', 'archive_task', 'organize_task')", required: true },
